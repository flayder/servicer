<template>
  ...
  >
    <div class="flex gap-2.5 w-full tablet:flex-col">
      <div class="relative w-[50%] h-[193px] tablet:w-full tablet:h-[250px]">
        <nuxt-link
          :to="getDetailPage()">
          <nuxt-img
            :src="item.photos[0]"
      ...
      <div class="flex flex-col gap-[13px] w-[50%] tablet:w-full">
        <div class="flex flex-wrap gap-[5px]">
          <!-- <ui-hash
            text="tag red"
            background-color="rgba(255, 24, 95, 0.1)"
            color="rgb(255, 24, 95)"
          /> -->
          <ui-hash 
            :text="tag.name"
        ...
        <div class="flex flex-col gap-1.5 tablet:hidden">
    ...
    <div class="flex gap-2.5 w-full tablet:flex-col">
      ...
      <div class="w-[50%] flex flex-col gap-1 tablet:w-full tablet:flex-row">
        <div class="tablet:w-[153px]" v-if="item.phone">
          <ui-button width="100%">
            <img
              src="/svg/phone.svg"
              width="16"
      ...
      <div class="hidden tablet:flex flex-wrap gap-1.5">
        <template v-for="block in item.block_times">
          <div class="flex items-center gap-0.5" v-if="block.value > 0 || block.value_eng > 0">
            <img
              src="/svg/clock.svg"
              width="16"
              height="16"
